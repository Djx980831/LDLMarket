...
/**
 * CdlEmploytype entity. @author MyEclipse Persistence Tools
 */

public class CdlEmploytype implements java.io.Serializable {
	...
	/** default constructor */
	public CdlEmploytype() {
	}

	/** full constructor */
	public CdlEmploytype(String cdName, String cdAvailability,
			BigDecimal cdIndex) {
		this.cdName = cdName;
