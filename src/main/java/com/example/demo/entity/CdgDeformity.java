...
/**
 * CdgDeformity entity. @author MyEclipse Persistence Tools
 */

public class CdgDeformity implements java.io.Serializable {
	...
	/** full constructor */
	public CdgDeformity(String cdName, String cdAvailability, BigDecimal cdIndex) {
		this.cdName = cdName;
