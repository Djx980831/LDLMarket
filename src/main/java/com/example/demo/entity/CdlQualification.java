...
/**
 * CdlQualification entity. @author MyEclipse Persistence Tools
 */

public class CdlQualification implements java.io.Serializable {
	...
	/** default constructor */
	public CdlQualification() {
	}

	/** full constructor */
	public CdlQualification(String cdName, String cdAvailability,
			BigDecimal cdIndex) {
		this.cdName = cdName;
