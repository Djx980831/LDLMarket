...
/**
 * CdgEducationallevel entity. @author MyEclipse Persistence Tools
 */

public class CdgEducationallevel implements java.io.Serializable {
	...
	/** default constructor */
	public CdgEducationallevel() {
	}

	/** full constructor */
	public CdgEducationallevel(String cdName, String cdAvailability,
			BigDecimal cdIndex) {
		this.cdName = cdName;
