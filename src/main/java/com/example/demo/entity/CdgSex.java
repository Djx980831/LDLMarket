...
/**
 * CdgSex entity. @author MyEclipse Persistence Tools
 */

public class CdgSex implements java.io.Serializable {
	...
	/** full constructor */
	public CdgSex(String cdName, String cdAvailability, BigDecimal cdIndex) {
		this.cdName = cdName;
