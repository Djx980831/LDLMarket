...
/**
 * CdlOrgtype entity. @author MyEclipse Persistence Tools
 */

public class CdlOrgtype implements java.io.Serializable {
	...
	/** full constructor */
	public CdlOrgtype(String cdName, String cdAvailability, BigDecimal cdIndex) {
		this.cdName = cdName;
