...
/**
 * CdgPoliticsaspect entity. @author MyEclipse Persistence Tools
 */

public class CdgPoliticsaspect implements java.io.Serializable {
	...
	/** default constructor */
	public CdgPoliticsaspect() {
	}

	/** full constructor */
	public CdgPoliticsaspect(String cdName, String cdAvailability,
			BigDecimal cdIndex) {
		this.cdName = cdName;
