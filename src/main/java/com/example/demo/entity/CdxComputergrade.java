...
/**
 * CdxComputergrade entity. @author MyEclipse Persistence Tools
 */

public class CdxComputergrade implements java.io.Serializable {
	...
	/** default constructor */
	public CdxComputergrade() {
	}

	/** full constructor */
	public CdxComputergrade(String cdName, String cdAvailability,
			BigDecimal cdIndex) {
		this.cdName = cdName;
