...
/**
 * CdgIndustry entity. @author MyEclipse Persistence Tools
 */

public class CdgIndustry implements java.io.Serializable {
	...
	/** full constructor */
	public CdgIndustry(String cdName, String cdAvailability, BigDecimal cdIndex) {
		this.cdName = cdName;
