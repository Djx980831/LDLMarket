...
/**
 * CdgMarriage entity. @author MyEclipse Persistence Tools
 */

public class CdgMarriage implements java.io.Serializable {
	...
	/** full constructor */
	public CdgMarriage(String cdName, String cdAvailability, BigDecimal cdIndex) {
		this.cdName = cdName;
