...
/**
 * CdgNation entity. @author MyEclipse Persistence Tools
 */

public class CdgNation implements java.io.Serializable {
	...
	/** full constructor */
	public CdgNation(String cdName, String cdAvailability, BigDecimal cdIndex) {
		this.cdName = cdName;
