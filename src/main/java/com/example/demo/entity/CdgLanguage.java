...
/**
 * CdgLanguage entity. @author MyEclipse Persistence Tools
 */

public class CdgLanguage implements java.io.Serializable {
	...
	/** full constructor */
	public CdgLanguage(String cdName, String cdAvailability, BigDecimal cdIndex) {
		this.cdName = cdName;
