...
/**
 * CdgRegioncode entity. @author MyEclipse Persistence Tools
 */

public class CdgRegioncode implements java.io.Serializable {
	...
	/** default constructor */
	public CdgRegioncode() {
	}

	/** full constructor */
	public CdgRegioncode(String cdName, String cdAvailability,
			BigDecimal cdIndex) {
		this.cdName = cdName;
