...
<script>
	function doSubmit(){
		...
		if(!flag){	
		form1.action = "<%=request.getContextPath()%>/jsp/zj/tjhz/grtj_tjpp_4.jsp";
		form1.submit();
		}else{
			alert("请勾选单位!");
			return;
    ...
    <td align="center" valign="top" style="padding-top:5px">
        <TABLE width="98%" border=1 cellPadding=0 cellSpacing=0 bordercolor="#FFFFFF" class=tablebody>
          <TBODY>
            ...
            <TR> 
              <TD align="center" class=line2><input name="radio" type="radio" class="radio" value="<bean:write name='grtjForm' property='bio_id' />" ></TD>
              <TD align="center" class=line1><a href="javascript:void(null)" style="cursor:hand" onclick="window.open('<%=request.getContextPath()%>/ldlsc/tjhz/dwtj.do?method=queryDwByID&bio_id=','dwjbxx','left=100 top=100 width=820,height=469 scrollbars')" ></a></TD>
