    ...
    <td align="center" valign="top" style="padding-top:5px">
      <TABLE width="98%" border=0 cellPadding=0 cellSpacing=1 bordercolor="#9DCBEC" class=tablebody>
          <TBODY>
            <TR class="line2">
              <TD width="72">姓&nbsp;&nbsp;&nbsp;&nbsp;名：</td>
			  <td width="199"><a href="javascript:void(null)" style="cursor:hand" onclick="window.open('','','left=100 top=100 width=820,height=469 scrollbars')" >xxx</a></td>
			  <td width="183">性别：xxx</td>
			  <td width="117">居住地址：</td>
			  <td width="379">xxx</TD>
            </TR>
            <TR class="line1">
              <TD>单位名称：</td>
			  <td colspan="2"><a href="javascript:void(null)" style="cursor:hand" onclick="window.open('','','left=100 top=100 width=820,height=469 scrollbars')" >xxx</a></td>
...
<table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
	<tr>
	<td align="center"  class="line2"><input name="button2" type="button"class=BUTTONs3  value="确 定" onClick="window.location.href='grtj_tjx.jsp'">&nbsp;&nbsp;
