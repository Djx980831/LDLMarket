...
<script>
	function doSubmit(){
		...
		form1.action = "<%=request.getContextPath()%>/jsp/zj/tjhz/dwtjfw_2.jsp";
		form1.submit();
	}
</script>
</head>
    ...
    <TR> 
      <TD align="center" class="line2"> <table width="250" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td width="50%" align="left"> <input name="bio_no" type="text" maxlength="32" value=""></td>
          </tr>
        </table></TD>
    </TR>
    <TR> 
      <TD align="center" class="line1"> <table width="250" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td width="50%" align="left"> <input name="bio_name" type="text" maxlength="32" value=""></td>
          </tr>
        </table></TD>
    </TR> 
</TABLE>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    <TR align="center" class="line2"> 
      <TD>
        <input name="button2" type="button" class=BUTTONs3 value="确 定" onClick="doSubmit()"> 
