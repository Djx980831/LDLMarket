...
<table width="98%" align="center" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="20" valign="bottom"><img src="<%=request.getContextPath()%>/styles/images/right/now.gif" width="11" height="12">当前位置：职业介绍 
        &gt; 推荐服务 &gt; 推荐信回执<a href="../../ldlgl/syrygl/zyjs/dj_a.htm"></a></td>
    </tr>
    <tr>
...
<tr>
  ...
  <td width="55%" height="25" align="left"  class="line2" ><font size="2">
    <select name="sfcg" style="width:160px" onchange="change()">
...
<tr id="aa" style="display:none">
  ...
  <td height="25" align="left"  class="line1" ><input name="yx" type="text" size="15"></td>
</tr>
 <tr id="cc" >
   <td align="right"  class="line1" valign="middle">不成功原因</td> 
   <td align="left" valign="middle"  class="line1"><textarea name="bcgyy" rows="3" cols="30"></textarea></td>
</tr>
</table>
<br> 
<table width="98%" align="center" border="0" cellspacing="0" cellpadding="0" class="linetable">
<tr> 
  <td align="center" class="line2"><input type="button" class="BUTTONs3" name="baoc" value="回 执" onclick="check()">&nbsp;&nbsp;<input name="button22" type="button"class=BUTTONs3  value="返 回"  onclick="toBack()">　</td>
</tr>
</table> 
</form>
</body>
