...
<script>
	...
	function doSubmit(){
		...
		if(form1.flag.value=="tj"){
			form1.action = "<%=request.getContextPath()%>/jsp/zj/tjhz/grtj_tjpp_1.jsp";
		}else{
			form1.action = "<%=request.getContextPath()%>/jsp/zj/tjhz/grtj_yxpp_1.jsp";
		}
		form1.submit();
	}
</script>
            ...
            <TR > 
              ...
              <table id="tjpp" width="273" border="0" cellspacing="0" cellpadding="0" height="84">
                  <tr> 
                    ...
                    <td width="194"> <input name="bip_citizenid" type="text" maxlength="18"></td>
                  </tr>
                  <tr> 
                    <td width="103">姓　　　名</td>
                    <td width="194"> <input name="bip_name" type="text" maxlength="32"></td>
                  </tr>
                </table>
                </TD>
            </TR>
            <TR > 
              ...
              <table id="yxpp" width="250" border="0" cellspacing="0" cellpadding="0" style="display:none">
                  ...
                  <tr> 
                    ...
                    <td width="194"> <input name="bio_no" type="text" maxlength="32"></td>
                  </tr>   
                  <tr> 
                    <td width="103">单位&nbsp;&nbsp;&nbsp;名称</td>
                    <td width="194"><input name="bio_name" type="text" maxlength="32"></td>
                  </tr>                                               
                </table>
                </TD>
            </TR>            
