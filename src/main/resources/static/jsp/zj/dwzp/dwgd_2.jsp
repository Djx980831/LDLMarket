 ...
 function guidang(){
     var flag = false;
		...
		if(window.confirm("您确定要归档吗？")){
			   form1.action="<%=request.getContextPath()%>/dwgd.do?method=dwgdcr";
    ...
    function backPage(){
               form1.action="<%=request.getContextPath()%>/jsp/zj/dwzp/dwgd_1.jsp";
		       form1.button1.disabled = true;
			   form1.button2.disabled = true; 
			   form1.submit();
    }
  ...
  <tr> 
	...
	<TABLE width="98%" border=1 cellPadding=0 cellSpacing=0 bordercolor="#FFFFFF" class="tablebody" id="mytable">
            <TR>
              ...
              <TD align="center" class="line4" ><INPUT TYPE="checkbox" class="radio" name="pkdata" onclick="" value=""></TD>
