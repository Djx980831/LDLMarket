...
function doSubmit(){
	...
	form1.action="<%=request.getContextPath()%>/jsp/zj/dwzp/dwdj_dj_3.jsp";
	form1.submit();

}

function toBack(){
		window.location.href="<%=request.getContextPath()%>/jsp/zj/dwzp/dwdj_dj_1.jsp";
	}
</script>
</head>
<body>
...
<tr>
  <td valign="top">	
    <table width="100%" align="center" border="0" cellpadding="1" cellspacing="1" >
      ...
      <tr align="center"  >
		<td class="line4"><input type="checkbox" name="cb" onclick="either(this,form1.cb)" value=""></td>
        <td class="line4"></td>
        <td class="line4"></td>
        <td class="line4"></td>
        <td class="line4"></td>
