...
<script>
	...
	function doInsert(){
		...
		form1.action="<%=request.getContextPath()%>/jsp/zj/dwzp/dwdj_3.jsp";
		form1.submit();
	}
	function copyValue(){
        ...
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="0">
              <tr class="line2">
                ...
                <td width="18%" >
			      <input name="dwfrm" style="WIDTH: 100%" maxlength="32" value="1" readonly></td>
              ...
              <tr class="line1">
                ...
                <td width="18%"><select name="dwxz" style="WIDTH: 100%;">
                ${Orgtype }
                </select></td>
              ...
              <tr class="line1">
                ...
                <td ><select name="dwszs" style="WIDTH: 100%" onchange="initCity()">
               ${Regioncode }
