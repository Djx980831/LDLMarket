...
function dwdj(){
	...
	form1.action="<%=request.getContextPath()%>/UnitsFreeze.do?method=unitsFreeze";
	form1.submit();
	}
function gzdj(){
...
<TABLE width="98%" align="center"  border=1 cellPadding=0 cellSpacing=0 bordercolor="#FFFFFF" class=tablebody>
    <TR class="line2"> 
      <TD width="10%" align="center" class="line4">状态</TD>
...
<logic:present name="uff" scope="request">
    ...
    <TR class="line2"> 
      ...
      <TD width="24%" align="center" class="line4"><bean:write name="uff" property="bio_name"/></TD>
      <TD width="24%" align="center" class="line4"><bean:write name="uff" property="bio_bua_address"/></TD>
      <TD width="17%" align="center" class="line4"><bean:write name="uff" property="bio_con_fax"/></TD>
      <TD width="12%" align="center" class="line4"><bean:write name="uff" property="djsj"/></TD>
    </TR>
