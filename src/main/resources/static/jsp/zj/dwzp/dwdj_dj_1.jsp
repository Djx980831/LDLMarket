...
<script>
	function doSubmit(){
		...
		window.location.href="<%=request.getContextPath()%>/jsp/zj/dwzp/dwdj_dj_2.jsp";
			...
			<table width="297" border="0" cellspacing="0" cellpadding="0">
	            <tr> 
	               <td width="90" align="right">单位法人码</td>
	                ...
	                <td width="160"><input name="bio_no" type="text" maxlength="64" style='width:100%'></td>
     ...
     <tr>
		<TD align="center" class="line1"> 
			<table width="297" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <td width="23"  align="right"></td>
                  <td width="160"><input name="bio_name" type="text" maxlength="64" style='width:100%'></td>
				  <td width="24"  align="right"></td>
                </tr>
            </table>
        </TD>
