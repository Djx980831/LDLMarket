...
<script>
	...
	function toBack(){
		window.location.href="<%=request.getContextPath()%>/jsp/zj/grqz/qzdjjd_1.jsp";
	}
	...
	function dosubmit(){
		...
		form1.action="<%=request.getContextPath()%>/jsp/zj/grqz/qzdjjd_3.jsp";
		form1.submit();	
      ...
      <TABLE width="98%" border=1 cellPadding=0 cellSpacing=0 bordercolor="#FFFFFF" class="tablebody">
          <TBODY>
            ...
            <TR align="center" class="line4"> 
              ...
              <TD width="6%"><a href="javascript:void(null)" style="cursor:hand" onclick="window.open('<%=request.getContextPath()%>/','详细信息','left=100 top=100 width=820,height=469 scrollbars')" ></TD>
              <TD width="6%"></TD>
              <TD width="16%"></TD>
              <TD width="20%"></TD>
              <TD width="10%"></TD>
