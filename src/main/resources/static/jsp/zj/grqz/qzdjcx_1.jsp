...
<TABLE width="80%" align="center"
    ...
    <td width="58%" valign="top">		
		<TABLE width="100%" align="center"
			border="0" cellPadding="0" cellSpacing="0" bordercolor="#FFFFFF" class="tablebody">
        <tr class="line2">
          <td width="75" align="right">身份证号码</td>
          <td> 
            <INPUT  name="dwfrm" style="WIDTH: 100%" maxlength="18" ></td>
          <td width="55" align="right">求职姓名</td>
      ...
      <TABLE width="100%" 
        ...
        <TR align="center"> 
          <TD align="center" class="line2"> 
            <input name="bc" type="button"class="BUTTONs3" id="bc" value="查 询" onClick="window.location.href='<%=request.getContextPath() %>/jsp/zj/grqz/qzdjcx_2.jsp'" > 
